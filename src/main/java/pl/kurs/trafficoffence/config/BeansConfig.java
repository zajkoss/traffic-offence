...
public class BeansConfig {
    ...
    public ApplicationRunner dataInitializer(OffenceRepository offenceRepository, PersonRepository personRepository) {
        return args -> {
            Person person1 = new Person("Jan","Kowalski","lukz1184@gmail.com","17252379565",new HashSet<>(),null);
            Person person2 = new Person("Anna","Kowalska","lukz1184@gmail.com","93102298064",new HashSet<>(),null);
            personRepository.save(person1);
            personRepository.save(person2);
            Offence offence1 = new Offence(LocalDateTime.of(2022, 6, 20, 10, 0),5, new BigDecimal("100.00"),new HashSet<>(),person1);
            Offence offence2 = new Offence(LocalDateTime.of(2022, 6, 20, 10, 0),5, new BigDecimal("200.00"),new HashSet<>(),person1);
            Offence offence3 = new Offence(LocalDateTime.of(2022, 6, 20, 15, 0),5, new BigDecimal("300.00"),new HashSet<>(),person1);
